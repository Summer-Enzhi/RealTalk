from src.models.src_step_audio.funasr_detach.frontends.default import DefaultFrontend
from src.models.src_step_audio.funasr_detach.frontends.s3prl import S3prlFrontend
import numpy as np
import torch
