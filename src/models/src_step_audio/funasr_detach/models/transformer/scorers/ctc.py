...
from src.models.src_step_audio.funasr_detach.models.transformer.scorers.ctc_prefix_score import CTCPrefixScore
from src.models.src_step_audio.funasr_detach.models.transformer.scorers.ctc_prefix_score import CTCPrefixScoreTH
